...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=grpc.go.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f,
	...
	0x28, 0x0e, 0x32, 0x17, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x2e, 0x53, 0x74, 0x6f,
	...
	0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x2e, 0x4d, 0x65,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: grpc.go.Storage.Driver
	(*Storage)(nil),     // 1: grpc.go.Storage
	(*Memory)(nil),      // 2: grpc.go.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: grpc.go.Storage.driver:type_name -> grpc.go.Storage.Driver
	2, // 1: grpc.go.Storage.memory:type_name -> grpc.go.Memory
