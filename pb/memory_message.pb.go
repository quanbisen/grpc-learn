...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc.go.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpc.go.Memory.Unit
	(*Memory)(nil),   // 1: grpc.go.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc.go.Memory.unit:type_name -> grpc.go.Memory.Unit
