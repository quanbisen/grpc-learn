...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=grpc.go.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x22,
	...
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x72,
	0x70, 0x63, 0x2e, 0x67, 0x6f, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x2e, 0x52, 0x65, 0x73,
	...
	0x28, 0x0e, 0x32, 0x15, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x2e, 0x53, 0x63, 0x72,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: grpc.go.Screen.Panel
	(*Screen)(nil),            // 1: grpc.go.Screen
	(*Screen_Resolution)(nil), // 2: grpc.go.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: grpc.go.Screen.resolution:type_name -> grpc.go.Screen.Resolution
	0, // 1: grpc.go.Screen.panel:type_name -> grpc.go.Screen.Panel
